...
gulp.task("copyImages", function() {
  return gulp
    .src("src/img/**/**.{svg,gif,png,jpg,jpeg}", {
      allowEmpty: true
    })
...
gulp.task("css", function() {
  return gulp
    .src(["src/components/_core/**.sass", "src/components/**/**.sass"], {
      allowEmpty: true
    })
    .pipe(srcmap.init())
...
gulp.task("serve", function() {
  browserSync.init({
    ...
    gulp.watch(["src/components/**/**.sass"], gulp.series("css")),
